...
my_printer_1 = Printer('Hp', 'XS5050', 111, ['white', 'blue', 'green'])
my_printer_2 = Printer('Canon', 'TS304', 222, ['black'])
my_printer_3 = Printer('Xerox', 'B210', 333, ['red', 'blue', 'green'])
my_printer_4 = Printer('Xerox', 'B210', 444, ['red', 'blue', 'green'])
my_printer_5 = Printer('Xerox', 'B211', 555, ['red', 'blue', 'green'])
